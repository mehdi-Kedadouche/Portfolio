...
export const iconPaths = {
	...
	'database': `<ellipse cx="128" cy="80" rx="88" ry="48" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
	<path d="M40,80v48c0,26.51,39.4,48,88,48s88-21.49,88-48V80" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
	<path d="M40,128v48c0,26.51,39.4,48,88,48s88-21.49,88-48V128" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
	`,
	...
	'fiber': `<circle cx="128" cy="128" r="96" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
	<path d="M88,128c0,37.46,13.33,70.92,34.28,93.49a7.77,7.77,0,0,0,11.44,0C154.67,198.92,168,165.46,168,128s-13.33-70.92-34.28-93.49a7.77,7.77,0,0,0-11.44,0C101.33,57.08,88,90.54,88,128Z" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
	<line x1="37.46" y1="96" x2="218.54" y2="96" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
	<line x1="37.46" y1="160" x2="218.54" y2="160" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
	`,
};
...
//  * 3. Collez le code SVG dans votre éditeur.
//  * 4. Supprimez le wrapper `<svg>` pour n'avoir que des éléments comme `<path>`, `<circle>`, `<rect>` etc.
//  * 5. Supprimez tous les attributs `Stroke="#000000"`
//  * 6. Remplacez tous les attributs `fill="#000000"` par `Stroke="none"`
//  * (ou ajoutez `Stroke="none"` sur les formes sans `fill` ou `Stroke` spécifié).
//  * 
